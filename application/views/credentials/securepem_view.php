<?php echo form_open(); ?>
	...
	<img id="app_logo" src="<?php echo base_url();?>assets/images/SecurePEMlogo_05.png">
	
	<ul>
		<li>
			<div class="email">
				<input type="email" name="email" placeholder="E-MAIL ADDRESS"
					required="required" value="<?php echo set_value('email', @$credentials->email); ?>">
			</div>
		</li>
		...
		<li>
			<div class="organization">
				<input type="text" id="organization" name="organization" placeholder="ORGANIZATION"
					value="<?php echo set_value('organization', @$credentials->organization); ?>">
			</div>
		</li>
